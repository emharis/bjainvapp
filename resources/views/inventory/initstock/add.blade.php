          ...
          <tbody>
            ...
            @foreach($barang as $dt)
              <tr >
                ...
                <td>
                  <input type="text" name="qty" class="hide form-control real-qty-input-on-row text-right input-sm" value="" min="0" data-id="{{$dt->id}}" >
                </td>
                <td>
                  <input type="text" name="harga_beli" class="hide form-control real-cost-input-on-row text-right input-sm" value="" min="0" data-id="{{$dt->id}}" >
                </td>
              </tr>
            @endforeach
          </tbody>
