...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-body">
            <a class="btn btn-primary btn-sm" id="btn-add" href="sales/customer/add" ><i class="fa fa-plus" ></i> Add Customer</a>
            ...
            <table class="table table-bordered table-condensed table-striped table-hover" id="table-customer" >
                ...
                <tbody>
                    @foreach($data as $dt)
                    <tr data-rowid="{{$rownum}}" data-customerid="{{$dt->id}}">
                        <td>{{$rownum++}}</td>
                        <td>{{$dt->nama}}</td>
                        ...
                        <td>
                            <a class="btn btn-success btn-xs btn-edit-customer" href="sales/customer/edit/{{$dt->id}}" ><i class="fa fa-edit" ></i></a>
                            {{-- @if($dt->ref == 0) --}}
