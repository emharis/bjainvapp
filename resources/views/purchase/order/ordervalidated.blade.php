...
<section class="content">
    ...
    <!-- Default box -->
    <div class="box {{$po_master->status == 'V' ? 'box-solid':'box-danger'}}">
          ...
          {{-- <label> <small>Purchase Order</small> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" >{{$po_master->po_num}}</h4></label> --}}
            ...
            <div class="row" >
                ...
                <div class="col-lg-12" >
                    {{-- <button type="submit" class="btn btn-primary" id="btn-save" >Save</button> --}}
                    @if($po_master->status != "C")
                        <button class="btn btn-warning" id="btn-cancel-order" data-href="purchase/order/cancel-order/{{$po_master->id}}" ><i class="fa fa-reply" ></i> Cancel Order</button>
                    &nbsp;&nbsp;&nbsp;
                    @endif
