                ...
                <tbody>
                    ...
                    @foreach($po_barang as $dt)
                        <tr class="row-product"  >
                            ...
                            <td>
                                <input autocomplete="off" type="text"  data-barangid="{{$dt->barang_id}}" data-kode="" class="text-uppercase form-control input-product input-sm input-clear"  value="{{'['$dt->kode_barang.'] ' . ' ' . $dt->kategori .' ' . $dt->nama_barang}}" readonly >
                            </td>
                            <td>
