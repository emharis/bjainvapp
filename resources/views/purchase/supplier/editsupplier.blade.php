...
<section class="content-header">
    <h1>
        <a href="purchase/supplier" >Supplier</a> <i class="fa fa-angle-double-right" ></i> Edit
    </h1>
</section>

<!-- Main content -->
<section class="content">
  <form method="POST" action="purchase/supplier/update" >
    <input type="hidden" name="id" value="{{$data->id}}">
    <div class="box box-primary" >
      <div class="box-body" >
        <div class="form-group">
            <label >Nama Supplier</label>
            <input autofocus autocomplete="off" required type="text" class="form-control input-lg" placeholder="Nama Supplier" name="nama" value="{{$data->nama}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="row" >
              <div class="col-lg-2" >
                <input required autocomplete="off" type="number" class="form-control text-right" placeholder="1" min="1" name="tempo" value="{{$data->jatuh_tempo}}">
              </div>
