...
<section class="content-header">
    <h1>
        ...
        <a href="invoice/customer-invoice/show/{{$data->id}}" >{{$data->no_inv}}</a> 
        <i class="fa fa-angle-double-right" ></i> 
        Register Payment
    </h1>
</section>
...
<section class="content">
    {{-- data hidden  --}}
    <input type="hidden" name="customer_inv_id" value="{{$data->id}}">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
            ...
            <label> 
                ...
                <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" >{{$data->no_inv}}</h4>
            </label>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5" >
                                ...
                                <a class="btn btn-danger" id="btn-cancel" href="invoice/customer-invoice/show/{{$data->id}}" >Cancel</a>
                            </td>
                        </tr>
