...
<section class="content-header">
    <h1>
        ...
        <a href="invoice/customer/payment/edit/{{$customer_payment->id}}" >{{$customer_payment->payment_number}}</a>
        <i class="fa fa-angle-double-right" ></i> 
        {{$data->no_inv}}
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-solid" >
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
            ...
            @endif --}}
                <label> <small>Customer Invoice</small> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" >{{$data->no_inv}}</h4></label>
            ...
            <div class="box-footer" >
                <a class="btn btn-danger" href="invoice/customer/payment/edit/{{$customer_payment->id}}" >Close</a>
            </div>
    </div>
