...
<section class="content">
    ...
    <div class="box box-solid">
        <form method="POST" action="cashbook/receipt/insert" >
            <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
                <label> <small>Add Cash Receipt</small> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" >NEW</h4></label>
