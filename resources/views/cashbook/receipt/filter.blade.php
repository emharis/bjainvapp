            ...
            <div class="row" >
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 pull-right" >
                    ...
                    <div class="input-group">
                        ...
                        {{-- Clear Filter --}}
                        <div class="input-group-btn" >
                            <a class="btn btn-danger" href="cashbook/receipt" ><i class="fa fa-refresh" ></i></a>
                        </div>
            ...
            <table class="table table-bordered table-condensed table-striped table-hover" id="table-order" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success btn-xs" href="cashbook/receipt/edit/{{$dt->id}}" ><i class="fa fa-edit" ></i></a>
                            <a class="btn btn-danger btn-xs btn-delete-receipt" href="cashbook/receipt/delete/{{$dt->id}}" ><i class="fa fa-trash-o" ></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
(function ($) {
    ...
    $('#btn-submit-filter').click(function(){
        ...
        var formFilter = $('<form>').attr('method','GET').attr('action','cashbook/receipt/filter');
