        ...
        <form method="POST" action="sales/report/show-report" >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td  >
                <?php echo Form::select('customer',$select_customer,null,['class'=>'form-control row-by-customer','disabled']); ?>
            ...
            <tr>
              ...
              <td  >
                <?php echo Form::select('salesperson',$select_salesperson,null,['class'=>'form-control row-by-salesperson','disabled']); ?>
