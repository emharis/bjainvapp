...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
            ...
            <table class="table no-border" >
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-4" >
                            <input type="text" name="customer" autofocus class="form-control text-uppercase" data-customerid="<?php echo e($so_master->customer_id); ?>" value="<?php echo e($so_master->nama_customer); ?>" required readonly>
                        </td>
                        ...
                        <td class="col-lg-2" >
                            <input type="text" name="tanggal" class="input-tanggal form-control" value="<?php echo e($so_master->tgl_formatted); ?>" required>
                        </td>
                    </tr>
                    <tr>
                        <td class="col-lg-2">
                        ...
                        <td class="col-lg-4" >
                            <input type="text" name="salesperson" class="form-control text-uppercase" data-salespersonid="<?php echo e($so_master->salesman_id); ?>" value="<?php echo e($so_master->salesman); ?>" required readonly>
                        </td>
                        <td class="col-lg-2" ></td>
                        ...
                        <td class="col-lg-2 hide" >
                            <input type="text" name="no_inv"  class="input-tanggal form-control" value="<?php echo e($so_master->no_inv); ?>"  readonly>
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <?php foreach($so_barang as $dt): ?>
                        <tr class="row-product"  >
                            ...
                            <td>
                                <input autocomplete="off" type="text"  data-barangid="<?php echo e($dt->barang_id); ?>" data-kode="<?php echo e($dt->kode_barang); ?>"  value="<?php echo e('['.$dt->kode_barang.'] '.$dt->kategori .' '.$dt->nama_barang); ?>" class="text-uppercase form-control input-product input-sm input-clear" >
                            </td>
                            <td>
                                <input type="text" readonly autocomplete="off" class="form-control text-right input-quantity-on-hand input-sm input-clear" value="<?php echo e($dt->quantity_on_hand); ?>"  >
                            </td>
                            <td>
                                <input type="number" autocomplete="off" min="1" class="form-control text-right input-quantity input-sm input-clear" value="<?php echo e($dt->qty); ?>" max="<?php echo e($dt->quantity_on_hand); ?>" >
                            </td>
                            <td>
                                <input autocomplete="off" type="text" class="text-right form-control input-unit-price input-sm input-clear" readonly="" value="<?php echo e($dt->std_unit_price); ?>" >
                            </td>
                            <td>
                                <input autocomplete="off" type="text" class="text-right form-control input-salesperson-unit-price input-sm input-clear" value="<?php echo e($dt->unit_price); ?>" >
                            </td>
                            <td>
                                <input autocomplete="off" type="text" readonly  class="text-right form-control input-subtotal input-sm input-clear" value="<?php echo e($dt->subtotal); ?>" >
                            </td>
                            <td class="text-center" >
                                <a href="#" class="btn-delete-row-product" ><i class="fa fa-trash" ></i></a>
                            </td>
            ...
            <div class="row" >
                <div class="col-lg-8" >
                    <textarea name="note" class="form-control" rows="3" style="margin-top:5px;" placeholder="Note" ><?php echo e($so_master->note); ?></textarea>
                    ...
                    <table class="table table-condensed" >
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >
                                   <input style="font-size:14px;" type="text" name="disc" class="input-sm form-control text-right input-clear" value="<?php echo e($so_master->disc); ?>" >
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="col-lg-12" >
                    <a class="btn btn-success" style="margin-top:0;" id="btn-validate-so" href="sales/order/validate/<?php echo e($so_master->id); ?>" ><i class="fa fa-check" ></i> Validate</a>
                    &nbsp;&nbsp;&nbsp;
