...
<section class="content-header">
    <h1>
        ...
        Posted on <?php echo e($data->tanggal_formatted); ?>
  ...
  <form name="form-start-inventory" method="POST" action="inventory/init-stock/insert" >
    ...
    <div class="box box-solid" >
      <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
        <?php /* PAGE TITLE */ ?>
        <label> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" >Initial Stock on <?php echo e($data->tanggal_formatted); ?></h4></label>
