...
<section class="content">
    ...
    <div class="box box-solid">
        ...
        <?php /* <div class="box-tools pull-right">
          <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu">
              <li><a target="_blank" href="report/sales/filter-by-date/pdf/<?php echo e($start_date); ?>/<?php echo e($end_date); ?>">Pdf</a></li>
              <li><a href="#">Xls</a></li>
            </ul>
          </div>
        </div> */ ?>
      ...
      <div class="box-footer" >
        <form action="sales/report/pdf-by-salesperson" method="POST" target="_blank" >
