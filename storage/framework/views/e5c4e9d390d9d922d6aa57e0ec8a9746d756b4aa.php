            ...
            <table class="table table-bordered table-condensed table-striped table-hover" id="table-order" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success btn-xs" href="cashbook/receipt/edit/<?php echo e($dt->id); ?>" ><i class="fa fa-edit" ></i></a>
                            <a class="btn btn-danger btn-xs btn-delete-receipt" href="cashbook/receipt/delete/<?php echo e($dt->id); ?>" ><i class="fa fa-trash-o" ></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
