...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
            <label><h3 style="margin:0;padding:0;font-weight:bold;" ><?php echo e($po_master->po_num); ?></h3></label>
        ...
        <div class="box-body">
            ...
            <table class="table" >
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-4" >
                            <input type="text" name="supplier" class="form-control" data-supplierid="<?php echo e($po_master->supplier_id); ?>" value="<?php echo e($po_master->supplier); ?>" required>
                        </td>
                        ...
                        <td class="col-lg-2" >
                            <input type="text" name="tanggal" class="input-tanggal form-control" value="<?php echo e($po_master->tgl_formatted); ?>" required>
                        </td>
                    </tr>
                    <tr>
                        <td class="col-lg-2">
                        ...
                        <td class="col-lg-4" >
                            <input type="text" name="no_inv" class="form-control" value="<?php echo e($po_master->no_inv); ?>" >
                        </td>
                        <td class="col-lg-2" ></td>
                        ...
                        <td class="col-lg-2 hide" >
                            <input type="text" name="jatuh_tempo"  class="input-tanggal form-control" value="<?php echo e($po_master->jatuh_tempo_formatted); ?>" >
                        </td>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    <?php foreach($po_barang as $dt): ?>
                        <tr class="row-product"  >
                            ...
                            <td>
                                <input autocomplete="off" type="text"  data-barangid="<?php echo e($dt->barang_id); ?>" data-kode="" class="text-uppercase form-control input-product input-sm input-clear"  value="<?php echo e('['$dt->kode_barang.'] ' . ' ' . $dt->kategori .' ' . $dt->nama_barang); ?>" readonly >
                            </td>
                            <td>
                                <input type="number" autocomplete="off" min="1" class="form-control text-right input-quantity input-sm input-clear" value="<?php echo e($dt->qty); ?>" >
                            </td>
                            <td>
                                <input autocomplete="off" type="text" class="text-right form-control input-unit-price input-sm input-clear" value="<?php echo e($dt->harga); ?>" >
                            </td>
                            <td>
            ...
            <div class="row" >
                <div class="col-lg-8" >
                    <textarea name="note" class="form-control" rows="4" style="margin-top:5px;" placeholder="Note" ><?php echo e($po_master->note); ?></textarea>
                </div>
                <div class="col-lg-4" >
                    <table class="table table-condensed" >
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td >
                                   <input style="font-size:14px;" type="text" name="disc" class="input-sm form-control text-right input-clear" value="<?php echo e($po_master->disc); ?>" >
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="col-lg-12" >
                    <a class="btn btn-success" style="margin-top:0;" id="btn-validate-po" ><i class="fa fa-check" ></i> Validate</a>
                    &nbsp;
                    &nbsp;
