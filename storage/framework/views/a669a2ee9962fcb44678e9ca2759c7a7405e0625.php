...
<section class="content-header">
    <h1>
        ...
        <a href="sales/order/edit/<?php echo e($so_master->id); ?>" ><?php echo e($so_master->so_no); ?></a>
        <i class="fa fa-angle-double-right" ></i>
        <?php if($multi_invoice): ?>
        <a href="sales/order/invoice/<?php echo e($so_master->id); ?>" >Invoices</a>
        <i class="fa fa-angle-double-right" ></i>
        <?php endif; ?>
        <?php echo e($cust_inv->no_inv); ?>
...
<section class="content">
    <?php /* data hidden  */ ?>
    <input type="hidden" name="customer_invoice_id" value="<?php echo e($cust_inv->id); ?>">

    <!-- Default box -->
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >

        <?php /* <?php if($cust_inv->status == "O"): ?>
            <a class="btn btn-primary" style="margin-top:0;" id="btn-reg-payment" href="sales/order/reg-payment/<?php echo e($cust_inv->id); ?>" >Register Payment</a>
        <?php else: ?>
            <label> <small>Invoice</small> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" ><?php echo e($cust_inv->no_inv); ?></h4></label>

        <?php endif; ?> */ ?>

            <label style="margin:0;padding:0;vertical-align: middle;" ><h3 style="margin:0;padding:0;font-weight:bold;" ><?php echo e($cust_inv->no_inv); ?></h3></label>

            <label class="pull-right" >&nbsp;&nbsp;&nbsp;</label>
            <a class="btn  btn-arrow-right pull-right disabled <?php echo e($cust_inv->status == 'P' ? 'bg-blue' : 'bg-gray'); ?>" >Paid</a>

            <label class="pull-right" >&nbsp;&nbsp;&nbsp;</label>

            <a class="btn btn-arrow-right pull-right disabled <?php echo e($cust_inv->status == 'O' ? 'bg-blue' : 'bg-gray'); ?>" >Open</a>
        ...
        <div class="box-body">
            ...
            <?php /* modul invoices */ ?>
            <?php /* <a class="btn btn-app pull-right" href="sales/order/invoice/<?php echo e($so_master->id); ?>" > */ ?>
                    <?php /* <span class="badge bg-green">1</span> */ ?>
                    <?php /* <i class="fa fa-newspaper-o"></i> Invoices */ ?>
                  <?php /* </a> */ ?>

            <?php /* <label>Purchase Order</label> */ ?>
            <?php /* <h3 style="margin-top:0;" ><label><?php echo e($so_master->no_inv); ?><label></h3> */ ?>
            <?php /* <?php if($cust_inv->status == "O"): ?>
            <label> <small>Invoice</small> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" ><?php echo e($cust_inv->no_inv); ?></h4></label>
            <?php endif; ?> */ ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-2" >
                            ...
                            <?php echo e($cust_inv->invoice_date_formatted); ?>
                    ...
                    <tr>
                        ...
                        <td class="col-lg-2" >
                            ...
                            <?php echo e($cust_inv->due_date_formatted); ?>
            ...
            <div class="row" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="label-amount-due" class=" text-right" style="font-size:18px;font-weight:bold;border-top:solid darkgray 1px;" >
                                    <?php echo e($cust_inv->amount_due); ?>
                ...
                <div class="col-lg-12" >
                    <a target="_blank" class="btn btn-success" id="btn-print-invoice" href="api/cetak-sales-order-invoice/<?php echo e($cust_inv->id); ?>" ><i class="fa fa-print" ></i> Print</a>
                    &nbsp;&nbsp;
                    <?php if($multi_invoice): ?>
                        <a class="btn btn-danger" href="sales/order/invoice/<?php echo e($so_master->id); ?>" ><i class="fa fa-close" ></i> Close</a>
                    <?php else: ?>
                        <a class="btn btn-danger" href="sales/order/edit/<?php echo e($so_master->id); ?>" ><i class="fa fa-close" ></i> Close</a>
                    <?php endif; ?>
