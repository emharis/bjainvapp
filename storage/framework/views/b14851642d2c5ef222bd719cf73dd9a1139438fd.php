                ...
                <tbody>
                    ...
                    <?php foreach($po_barang as $dt): ?>
                        <tr class="row-product"  >
                            ...
                            <td>
                                <input autocomplete="off" type="text"  data-barangid="<?php echo e($dt->barang_id); ?>" data-kode="" class="text-uppercase form-control input-product input-sm input-clear"  value="<?php echo e($dt->nama_barang_full); ?>" readonly >
                            </td>
                            <td>
