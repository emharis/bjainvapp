...
<section class="content-header">
    <h1>
        ...
        <a href="purchase/order/edit/<?php echo e($po_master->id); ?>" ><?php echo e($po_master->po_num); ?></a>
        <i class="fa fa-angle-double-right" ></i>
        <?php echo e($sup_bill->bill_no); ?>
...
<section class="content">
    <?php /* data hidden  */ ?>
    <input type="hidden" name="supplier_bill_id" value="<?php echo e($sup_bill->id); ?>">

    <!-- Default box -->
    <div class="box box-solid">
        <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >

        <?php /* <?php if($sup_bill->status == "O"): ?> */ ?>
            <?php /* <a class="btn btn-primary" style="margin-top:0;" id="btn-reg-payment" href="purchase/order/reg-payment/<?php echo e($po_master->id); ?>" >Register Payment</a> */ ?>
        <?php /* <?php else: ?> */ ?>
            <?php /* <label> <small>Invoice</small> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" ><?php echo e($sup_bill->bill_no); ?></h4></label> */ ?>
            <label>
              <h3 style="margin:0;padding:0;font-weight:bold;" ><?php echo e($sup_bill->bill_no); ?></h3>
            </label>
        <?php /* <?php endif; ?> */ ?>

            <label class="pull-right" >&nbsp;&nbsp;&nbsp;</label>
            <a class="btn  btn-arrow-right pull-right disabled <?php echo e($sup_bill->status == 'P' ? 'bg-blue' : 'bg-gray'); ?>" >Paid</a>

            <label class="pull-right" >&nbsp;&nbsp;&nbsp;</label>

            <a class="btn btn-arrow-right pull-right disabled <?php echo e($sup_bill->status == 'O' ? 'bg-blue' : 'bg-gray'); ?>" >Open</a>
        ...
        <div class="box-body">
            ...
            <?php /* modul invoices */ ?>
            <?php /* <a class="btn btn-app pull-right" href="purchase/order/invoice/<?php echo e($po_master->id); ?>" > */ ?>
            ...
            <?php /* <?php if($sup_bill->status == "O"): ?>
            <label> <small>Invoice</small> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" ><?php echo e($sup_bill->bill_no); ?></h4></label>
            <?php endif; ?> */ ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-2" >
                            ...
                            <?php echo e($sup_bill->bill_date_formatted); ?>
                    ...
                    <tr>
                        ...
                        <td class="col-lg-4" >
                            ...
                            <?php /* <a href="purchase/order/edit/<?php echo e($po_master->id); ?>" ><?php echo e($po_master->po_num); ?></a> */ ?>
                            <?php echo e($po_master->po_num); ?>
                        ...
                        <td class="col-lg-2" >
                            ...
                            <?php /* <?php echo e($po_master->jatuh_tempo_formatted); ?> */ ?>
                            <?php echo e($sup_bill->due_date_formatted); ?>
                ...
                <tbody>
                    ...
                    <?php foreach($po_barang as $dt): ?>
                        <tr>
                            ...
                            <td class="text-right" >
                                <?php echo e(number_format($dt->harga,0,'.',',')); ?>
            ...
            <div class="row" >
                        ...
                        <tbody>
                            ...
                            <?php foreach($payments as $dt): ?>
                                <tr style="background-color:#EEF0F0;" >
                                    ...
                                    <td class="text-right" >
                                        <i><?php echo e(number_format($dt->total,0,'.',',')); ?></i>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            <?php endif; ?>
                            <tr>
                                ...
                                <td id="label-amount-due" class=" text-right" style="font-size:18px;font-weight:bold;border-top:solid darkgray 1px;" >
                                    <?php echo e($sup_bill->amount_due); ?>
                ...
                <div class="col-lg-12" >
                    <?php /* <button type="submit" class="btn btn-primary" id="btn-save" >Save</button> */ ?>
                            <a class="btn btn-danger" href="purchase/order/edit/<?php echo e($po_master->id); ?>" >Close</a>
                </div>
            </div>
