...
<section class="content-header">
    <h1>
        <a href="inventory/init-stock" >Stock Valuation</a> 
    </h1>
</section>
  ...
  <form name="form-start-inventory" method="POST" action="inventory/init-stock/insert" >
    ...
    <div class="box box-solid" >
      <div class="box-header with-border" style="padding-top:5px;padding-bottom:5px;" >
        <?php /* PAGE TITLE */ ?>
        <label> <h4 style="font-weight: bolder;margin-top:0;padding-top:0;margin-bottom:0;padding-bottom:0;" >Inventory Details</h4></label>
