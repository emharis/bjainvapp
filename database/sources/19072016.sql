...
INSERT INTO `customer` (`id`, `created_at`, `nama`, `nama_kontak`, `telp`, `telp_2`, `alamat`) VALUES
	...
	(3, '2016-06-19 07:30:41', 'SUMBER JADI', 'BUDI', '( 031 ) 8946315', '', 'Jl Tanggulangin Sidoarjo'),
...
-- Dumping data for table bajaagung_db.jual: ~8 rows (approximately)
DELETE FROM `jual`;
...
INSERT INTO `jual` (`id`, `created_at`, `no_inv`, `tgl`, `customer_id`, `sales_id`, `total`, `disc`, `grand_total`, `tipe`, `status`, `can_edit`) VALUES
	...
	(9, '2016-07-13 10:51:36', 'PAR/130707', '2016-07-13', 9, 5, 451500, 0, 451500, 'K', 'N', 'Y'),
	(10, '2016-07-13 11:00:53', 'SUP/130708', '2016-07-13', 4, 4, 699300, 0, 699300, 'K', 'N', 'Y'),
	(11, '2016-07-13 11:04:46', 'ALI/130709', '2016-07-13', 2, 3, 1234800, 0, 1234800, 'K', 'N', 'Y'),
	(12, '2016-07-13 11:06:20', 'SUP/1307010', '2016-07-13', 5, 4, 3228750, 0, 3228750, 'K', 'N', 'Y'),
	(13, '2016-07-14 09:51:14', 'PAR/1407011', '2016-07-14', 3, 5, 451500, 0, 451500, 'K', 'N', 'Y');
...
-- Dumping data for table bajaagung_db.jual_barang: ~24 rows (approximately)
...
INSERT INTO `jual_barang` (`id`, `created_at`, `jual_id`, `barang_id`, `qty`, `harga_satuan`, `harga_salesman`, `total`) VALUES
	...
	(23, '2016-07-13 10:51:36', 9, 28, 1, 451500, 451500, 451500),
	(24, '2016-07-13 11:00:53', 10, 15, 2, 349650, 349650, 699300),
	(25, '2016-07-13 11:04:46', 11, 51, 4, 308700, 308700, 1234800),
	(26, '2016-07-13 11:06:20', 12, 41, 5, 645750, 645750, 3228750),
	(27, '2016-07-14 09:51:14', 13, 28, 1, 451500, 451500, 451500);
...
-- Dumping data for table bajaagung_db.piutang: ~8 rows (approximately)
DELETE FROM `piutang`;
...
INSERT INTO `piutang` (`id`, `created_at`, `jual_id`, `customer_id`, `total`, `lunas`, `sisa_bayar`, `sudah_bayar`) VALUES
	...
	(8, '2016-07-13 10:51:36', 9, 9, 451500, 'N', 451500, 0),
	(9, '2016-07-13 11:00:53', 10, 4, 699300, 'N', 699300, 0),
	(10, '2016-07-13 11:04:46', 11, 2, 1234800, 'N', 1234800, 0),
	(11, '2016-07-13 11:06:20', 12, 5, 3228750, 'N', 3228750, 0),
	(12, '2016-07-14 09:51:14', 13, 3, 451500, 'N', 451500, 0);
...
INSERT INTO `stok` (`id`, `created_at`, `tgl`, `barang_id`, `stok_awal`, `current_stok`, `tipe`, `harga`, `beli_id`) VALUES
	...
	(31, '2016-06-05 05:50:19', '2016-06-05', 15, 3, 0, 'M', 333000, NULL),
	...
	(45, '2016-06-05 05:59:50', '2016-06-05', 28, 8, 2, 'M', 430000, NULL),
	...
	(58, '2016-06-05 06:06:30', '2016-06-05', 41, 116, 111, 'M', 615000, NULL),
	...
	(72, '2016-06-05 06:15:17', '2016-06-05', 51, 6, 2, 'M', 294000, NULL),
...
INSERT INTO `stok_moving` (`id`, `created_at`, `stok_id`, `jumlah`, `tipe`, `jual_id`) VALUES
	...
	(120, '2016-07-13 10:51:36', 45, 1, 'O', 9),
	(121, '2016-07-13 11:00:53', 31, 2, 'O', 10),
	(122, '2016-07-13 11:04:46', 72, 4, 'O', 11),
	(123, '2016-07-13 11:06:20', 58, 5, 'O', 12),
	(124, '2016-07-14 09:51:14', 45, 1, 'O', 13);
