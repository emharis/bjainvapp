...
INSERT INTO `barang` (`id`, `created_at`, `kode`, `nama`, `kategori_id`, `rol`, `berat`, `harga_jual_current`) VALUES
	...
	(21, '2016-05-13 06:54:11', 'ST8-48', '0,2 X 76 - 48', 33, 10, 48, NULL),
	(22, '2016-05-13 06:54:32', 'ST8-45', '0,2 X 76 - 45', 33, 10, 45, NULL),
	...
	(35, '2016-05-13 07:33:14', 'BDRRT20', 'RRT 20', 36, 10, 20, NULL),
	(36, '2016-05-13 07:35:23', 'BDSQ', 'SQ', 36, 10, 25, NULL),
	...
	(64, '2016-06-05 05:57:09', 'PKKLB', 'KALSIBOT', 31, 10, 1, NULL),
	(65, '2016-06-05 06:08:21', 'KRBMDQ', 'MDQ', 37, 10, 25, NULL),
	(66, '2016-06-05 06:09:16', 'PKPYSQ', 'PAYUNG SQ', 31, 10, 15, NULL),
	(67, '2016-06-05 06:09:31', 'PKPYRRT', 'PAYUNG RRT', 31, 1, 48, NULL),
	(68, '2016-06-05 06:10:07', 'KWLKT114', 'LOKET 1 1/4', 35, 1, 1, NULL),
	(70, '2016-06-05 06:20:50', 'PKSP112', 'SP 1 1/2"', 31, 1, 30, NULL),
	(71, '2016-06-05 06:21:13', 'PKSP134', 'SP 1 3/4"', 31, 1, 30, NULL),
	(72, '2016-06-05 06:22:04', 'PKSP2', 'SP 2"', 31, 1, 30, NULL),
	(73, '2016-06-05 06:22:24', 'PKSP212+', 'SP 2 1/2+"', 31, 1, 30, NULL),
	(74, '2016-06-05 06:22:49', 'PKKG1', 'KING 1', 31, 1, 30, NULL),
	(75, '2016-06-05 06:23:05', 'PKKG114', 'KING 1 1/4"', 31, 1, 30, NULL),
	(76, '2016-06-05 06:23:24', 'PKKG112', 'KING 1 1/2"', 31, 1, 30, NULL),
	(77, '2016-06-05 06:23:48', 'PKKG134', 'KING 1 3/4"', 31, 1, 30, NULL),
	(78, '2016-06-05 06:24:00', 'PKKG2', 'KING 2"', 31, 1, 30, NULL),
	(79, '2016-06-05 06:24:23', 'PKKG212+', 'KING 2 1/2+"', 31, 1, 30, NULL),
	(80, '2016-06-05 06:24:58', 'PKPAQ58', 'PAQ 5/8', 31, 1, 10, NULL),
	(81, '2016-06-05 06:25:19', 'PK984', '98+ 4"', 31, 1, 30, NULL),
	(82, '2016-06-05 06:25:38', 'PKARC', 'ARCHO M', 31, 1, 1, NULL);
...
-- Dumping data for table bajaagung_db.customer: ~1 rows (approximately)
...
-- Dumping data for table bajaagung_db.harga_jual: ~0 rows (approximately)
...
-- Dumping data for table bajaagung_db.jual: ~0 rows (approximately)
DELETE FROM `jual`;
...
-- Dumping data for table bajaagung_db.jual_barang: ~0 rows (approximately)
...
-- Dumping data for table bajaagung_db.stok: ~68 rows (approximately)
DELETE FROM `stok`;
/*!40000 ALTER TABLE `stok` DISABLE KEYS */;
INSERT INTO `stok` (`id`, `created_at`, `tgl`, `barang_id`, `stok_awal`, `current_stok`, `tipe`, `harga`, `beli_id`) VALUES
	(1, '2016-06-05 05:29:35', '2016-06-05', 14, 10, 10, 'M', 243000, NULL),
	(30, '2016-06-05 05:50:05', '2016-06-05', 14, 1, 1, 'M', 243000, NULL),
	(31, '2016-06-05 05:50:19', '2016-06-05', 15, 3, 3, 'M', 333000, NULL),
	...
	(38, '2016-06-05 05:54:11', '2016-06-05', 21, 3, 3, 'M', 736800, NULL),
	...
	(44, '2016-06-05 05:59:30', '2016-06-05', 27, 1, 1, 'M', 480000, NULL),
	(45, '2016-06-05 05:59:50', '2016-06-05', 28, 8, 8, 'M', 430000, NULL),
	(46, '2016-06-05 06:00:22', '2016-06-05', 29, 7, 7, 'M', 450000, NULL),
	(47, '2016-06-05 06:00:48', '2016-06-05', 30, 2, 2, 'M', 237500, NULL),
	(48, '2016-06-05 06:01:02', '2016-06-05', 31, 1, 1, 'M', 250000, NULL),
	(49, '2016-06-05 06:01:21', '2016-06-05', 32, 26, 26, 'M', 228750, NULL),
	...
	(54, '2016-06-05 06:05:13', '2016-06-05', 37, 225, 225, 'M', 32500, NULL),
	(55, '2016-06-05 06:05:34', '2016-06-05', 38, 275, 275, 'M', 37900, NULL),
	(56, '2016-06-05 06:05:53', '2016-06-05', 39, 395, 395, 'M', 43350, NULL),
	...
	(63, '2016-06-05 06:11:33', '2016-06-05', 42, 1, 1, 'M', 309000, NULL),
	(64, '2016-06-05 06:11:50', '2016-06-05', 43, 3, 3, 'M', 306000, NULL),
	(65, '2016-06-05 06:12:04', '2016-06-05', 44, 1, 1, 'M', 300000, NULL),
	(66, '2016-06-05 06:12:22', '2016-06-05', 45, 1, 1, 'M', 286500, NULL),
	(67, '2016-06-05 06:12:42', '2016-06-05', 46, 12, 12, 'M', 276000, NULL),
	(68, '2016-06-05 06:13:00', '2016-06-05', 47, 5, 5, 'M', 256500, NULL),
	(69, '2016-06-05 06:14:14', '2016-06-05', 48, 40, 40, 'M', 253500, NULL),
...
-- Dumping data for table bajaagung_db.stok_moving: ~68 rows (approximately)
DELETE FROM `stok_moving`;
